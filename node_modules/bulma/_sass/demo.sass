...
.grid__item
  &:nth-child(even) .grid__item-img
    transform: rotate3d(0, 0, 1, 4deg)
  &:nth-child(odd) .grid__item-img
    transform: rotate3d(0, 0, 1, -4deg)
...
.js
  .content__item-title > span, .content__item-subtitle, .content__item-text
    opacity: 0

.content__close, .content__indicator
  opacity: 0
